...
export const applicationErrorCodes = ['UNAUTHORIZED', 'FORBIDDEN', 'VALIDATION_ERROR', 'SLOT_NOT_FOUND', 'SLOT_NOT_AVAILABLE', 'HOLD_EXPIRED', 'BOOKING_CONFLICT', 'IDEMPOTENCY_REPLAY', 'ELIGIBILITY_FAILED', 'INTEGRATION_UNAVAILABLE', 'BOOKING_STATE_UNKNOWN', 'INTERNAL_ERROR'] as const;
